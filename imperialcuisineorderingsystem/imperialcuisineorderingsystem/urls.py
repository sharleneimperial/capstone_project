"""imperialcuisineorderingsystem URL Configuration
...
from customer.views import Index, About, Menu, MenuSearch, Order_View, access_order, order_detail
...
urlpatterns = [
    ...
    # path('order/delete/', delete_order, name='delete-order'),
